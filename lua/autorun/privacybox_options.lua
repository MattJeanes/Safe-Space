if SERVER then
	util.AddNetworkString("PrivacyBox-DoubleTrace")
	
	net.Receive("PrivacyBox-DoubleTrace", function(len,ply)
		if ply:IsAdmin() or ply:IsSuperAdmin() then
			RunConsoleCommand("privacybox_doubletrace", net.ReadFloat())
		end
	end)
elseif CLIENT then
	...
	hook.Add("PopulateToolMenu", "PrivacyBox-PopulateToolMenu", function()
		spawnmenu.AddToolMenuOption("Options", "PrivacyBox", "PrivacyBox_Settings", "Settings", "", "", function(panel)
			panel:ClearControls()
			//Do menu things here
